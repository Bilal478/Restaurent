					...
					<div class="bg-white pd-20 box-shadow border-radius-5 height-100-p">
						<div class="project-info clearfix">
							...
							<div class="project-info-right">
								...
								<p class="weight-400 font-18">Total Restaurents</p>
							</div>
						</div>
					...
					<div class="bg-white pd-20 box-shadow border-radius-5 height-100-p">
						<div class="project-info clearfix">
							...
							<div class="project-info-right">
								...
								<p class="weight-400 font-18">Total Disheses </p></br></p>
							</div>
						</div>
						<div class="project-info-progress">
							<div class="row clearfix">
				...
				<div class="col-lg-3 col-md-6 col-sm-12 mb-30">
					<div class="bg-white pd-20 box-shadow border-radius-5 height-100-p">
						<div class="project-info clearfix">
							...
							<div class="project-info-right">
								<span class="no text-light-orange weight-500 font-24">2</span>
								<p class="weight-400 font-18">Total Admins</p></br>
							</div>
						</div>
						<div class="project-info-progress">
							<div class="row clearfix">
					...
					<div class="bg-white pd-20 box-shadow border-radius-5 margin-5 height-100-p">
						<div class="project-info clearfix">
							...
							<div class="project-info-right">
								...
								<p class="weight-400 font-18">Total Users</p><br>
							</div>
						</div>
						<div class="project-info-progress">
							<div class="row clearfix">
